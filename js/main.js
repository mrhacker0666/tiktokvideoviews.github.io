...
function FLICKSTATUS() {
  ...
  $(".tttmiddle").fadeOut(1250, function() {
    ...
    $(".tttmiddle").append('<h5 class="m-0"></span> ' + rIP + ' received <br><strong>' + rA + ' New Video Views</strong></h5>');
    $(".tttleft").fadeIn(1250);
      ...
      bar.animate(FLI/100, function() {
        ...
        $("#loading2").html(L222).fadeIn(750, function() {
            ...
            bar.animate(FLI/100, function() {
              ...
              var L3 = 'Sending Video Views (+' + $("#fans-select option:selected").val() + ') in the TikTok database...';
